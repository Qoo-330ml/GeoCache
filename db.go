...
func openDatabase(path string) (*gorm.DB, error) {
	...
	if err := db.AutoMigrate(&ActivationCode{}, &LicenseCheck{}, &ClientInstall{}, &IPReport{}, &IPBest{}, &FeaturePolicy{}, &OrganizerFailedRecordSubmission{}, &OrganizerFailedRecord{}); err != nil {
