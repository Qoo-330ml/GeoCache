...
func serveAdmin(c *gin.Context) {
	...
	c.String(http.StatusOK, renderAdminPage(adminPage{
        ...
        <button class="secondary" onclick="location.href='/admin/payment'">支付订单</button>
    ...
    <section class="panel">
      ...
      <div class="panel-body">
        <div class="nav-grid">
          ...
          <a class="nav-card" href="/admin/payment"><strong>支付订单</strong><span>配置 XorPay 并查看自动支付订单和发码状态。</span></a>
